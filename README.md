...
```sh
  cd my-folder
  git clone git@github.com:ikennarichard/Todo-App.git
```
...
Feel free to check the [issues page](https://github.com/ikennarichard/Todo-App/issues).
...
This project is [MIT](https://github.com/ikennarichard/Todo-App/blob/dev/LICENSE) licensed.
